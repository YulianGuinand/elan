...
export default function FillSidebar({
    ...
    return <aside className="w-full space-y-6"></aside>;
}
...
//                     <div className="w-20 h-20 rounded-full border-4 border-white overflow-hidden shadow-md bg-gray-100 flex items-center justify-center">
...
//                 </h2>
//                 <span className="inline-block mt-1 px-3 py-1 bg-orange-50 text-orange-600 rounded-lg text-[9px] font-black uppercase tracking-wider border border-orange-100/30">
...
//                 className="mt-6 text-[9px] font-black text-gray-300 hover:text-orange-500 uppercase tracking-widest flex items-center gap-1.5 mx-auto transition-colors group px-4 py-2 hover:bg-orange-50 rounded-lg"
//             >
