...
import { List, PenLine, Search, Upload } from "lucide-react";
            ...
            >
                <div className="space-y-6 mb-24 w-full">
                    ...
                    <FadeIn delay={100} className="w-full">
                        {activeTab === "saisie" && canManageEntreprise && (
                            <div className="bg-white rounded-xl border border-gray-200 p-6 w-full">
                                <EntrepriseForm />
                            </div>
                        )}

                        {activeTab === "import" && canManageEntreprise && (
                        ...
                        {activeTab !== "liste" &&
                            entreprises.data.length > 0 && (
                                <div>
                                    ...
                                    <EntrepriseTable
                                        entreprises={entreprises.data.slice(
                                            0,
                                            5,
                                        )}
