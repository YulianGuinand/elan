...
class StudentsController extends Controller
{
  ...
  public function index(Request $request): Response
  {
    ...
    // Simuler une requête de base de données avec filtres
  ...
  /**
   * Retourne la liste complète des apprenants (données placeholder)
   */
  private function getAllStudents(): array
  {
    return [
      [
        ...
        'avatar' => null,
        'program' => 'Développeur Web Fullstack',
